...
nodeSubmitElement.addEventListener(
  'click', function() {
    ...
    myData["nodes"].push({"name":"Marie","group":0});
    var marieIndex = myData["nodes"].findIndex(function(e) { return e["name"] == "Marie" });

    myData["links"].push({"source":marieIndex,"target":0,"value":1});
